...
BUILD_JAR=$(ls /home/ubuntu/seb43_main_002/Server/build/libs/Server-0.0.1-SNAPSHOT.war)
...
if [ -z $CURRENT_PID ]
then
  echo "> 현재 구동중인 애플리케이션이 없으므로 종료하지 않습니다." >> /home/ubuntu/seb43_main_002/deploy.log
else
  echo "> kill -9 $CURRENT_PID" >> /home/ubuntu/seb43_main_002/deploy.log
...
sudo nohup java -jar $DEPLOY_JAR >> /home/ubuntu/seb43_main_002/deploy.log 2>/home/ubuntu/seb43_main_002/deploy_err.log &